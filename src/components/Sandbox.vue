...
export default {
    ...
    mounted() {
        ...
        monaco.languages.setMonarchTokensProvider(languageId, {
            tokenizer: {
                root: [
                    [/(break|catch|continue|delete|else|enum|false|func|halt|handle|if|lock|loop|maybe|nil|parallel|random|render|ret|size|test|then|throw|true|type|unless|use|val|wait|when|while)\b/, "keyword.control.n8"],
