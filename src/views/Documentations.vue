        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="card border border-primary bg-transparent rounded-3 p-4 shadow-lg mb-4">
                    ...
                    <h4 class="my-2">1.1 &mdash; Overview</h4>
                    ...
                    <p>Moreover, Rhea is named after the <a href="https://en.wikipedia.org/wiki/Rhea_(moon)" target="_blank">Saturn&apos;s moon</a>. It is Saturn's second largest moon after Titan &mdash; a large, icy world, composed primarily of water ice with a small rocky core.</p>
                    <p>This documentations assumes familiarity with programming concepts but does not reference implementation-specific details of the Rhea programming language itself.</p>

                    <h4 class="my-2">1.2 &mdash; <span class="font-monospace">&quot;Hello, World&quot;</span> Program</h4>
                    ...
                    <h4 class="my-2">1.2 &mdash; The Value-Only Concept</h4>
                    <p>Rhea&apos;s core philosophy is &quot;value-only&quot;: there are no mutable variables or first-class functions in the traditional sense—everything you name is just a value. Under the hood, both what you&apos;d think of as variables and what you&apos;d think of as functions are simply values bound to names.</p>

                    <h5 class="my-2">1.2.1 &mdash; Values Instead of Variables</h5>
...
x = x + 1</pre>
                    ...
                    <h5 class="my-2">1.2.2 &mdash; Functions as Values</h5>
                    ...
                    <p>This is still exactly the same: an immutable binding of a function-value to <span class="rounded text-white bg-secondary px-1 font-monospace">add</span>.</p>

                    <h5 class="my-2">1.2.3 &mdash; No Distinction Between &quot;Variable&quot; and &quot;Function&quot;</h5>
                    ...
                    <h5 class="my-2">1.2.4 Mutable Functional yet Imperative?</h5>
                    <p>Rhea occupies a unique niche as a programming language by blending functional principles with mutable and imperative features, earning it the label "Mutable Functional yet Imperative." Rhea's functional idea that everything is a value-numbers, strings, maps, arrays, and even functions themselves. By default, bindings created with val (or its sugar form, name = …) are immutable, lending themselves to pure‐function design, easy reasoning, and safe concurrency. You compose small, deterministic functions into larger pipelines of transformation, without hidden side-effects.</p>
